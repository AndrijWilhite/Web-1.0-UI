...
function createTree (arrName, startNode, openNode) {
  ...
  if (nodes.length > 0) {
    ...
    if (startNode != 0) {
      ...
      document.write('<a href="' + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + '</a><br />')
    } else document.write('<img src="base.gif" align="absbottom" alt="" />Windows Gone Bad<br />')
...
function isNodeOpen (node) {
  for (i = 0; i < openNodes.length; i++) { if (openNodes[i] == node) return true}
  return false
}
  ...
  for (var i = 0; i < nodes.length; i++) {
    ...
    if (nodeValues[1] == parentNode) {
      ...
      if (hcn) {
        ...
        if (ls) document.write('<img src="join.gif" align="absbottom" alt="" />')
        else document.write('<img src="joinbottom.gif" align="absbottom" alt="" />')
      }
      ...
      } else document.write('<img id="icon' + nodeValues[0] + '" src="page.gif" align="absbottom" alt="Page" />')
